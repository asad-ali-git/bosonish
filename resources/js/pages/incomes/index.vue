  ...
  <div class="container px-6 mx-auto py-8 text-gray-600">
    <div class="flex flex-wrap">
      <div class="w-full sm:w-1/2 text-center sm:text-left">
        <PageTitle title="Manage Incomes" />
      </div>
      <div
      ...
      >
        ...
        <t-button
          ...
          @click="showIncomeSidePanel = true"
        >
          <IconBase
            class="w-4 h-4"
            viewBox="0 0 16 16"
          ...
          />
          <span class="px-4">Add Income</span>
        </t-button>
      </div>
    </div>
    <DataTable
